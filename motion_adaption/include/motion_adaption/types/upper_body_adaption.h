/**
 * @file /motion_adaption/include/motion_adaption/types/upper_body_adaption.h
 *
 * @brief File comment
 *
 * File comment
...
#ifndef UPPER_BODY_ADAPTION_H_
#define UPPER_BODY_ADAPTION_H_
...
class UpperBodyAdaption : public AdaptionType
{
public:
  UpperBodyAdaption(const MotionAdaptionParameters& adaption_parameters,
...
private:
  tf::TransformStamped tf_usr_torso_, tf_usr_head_;
  ...
  bool scaleElbowsAndShoulders()
  {
   ...
   //  tf_broadcaster_.sendTransform(tf::StampedTransform(tf_r_elbow_scaled_, ros::Time::now(), "/ref_frame", "/r_elbow_scaled"));
      internal_tf_.setTransform(tf::StampedTransform(tf_r_elbow_scaled_, calc_time,
   ...
   //   tf_broadcaster_.sendTransform(tf::StampedTransform(tf_r_hand_scaled_, ros::Time::now(), "/ref_frame", "/r_hand_scaled"));
      internal_tf_.setTransform(tf::StampedTransform(tf_r_hand_scaled_, calc_time,
    ...
    //  tf_broadcaster_.sendTransform(tf::StampedTransform(tf_l_elbow_scaled_, ros::Time::now(), "/ref_frame", "/l_elbow_scaled"));
      internal_tf_.setTransform(tf::StampedTransform(tf_l_elbow_scaled_, calc_time,
     ...
     // tf_broadcaster_.sendTransform(tf::StampedTransform(tf_l_hand_scaled_, ros::Time::now(), "/ref_frame", "/l_hand_scaled"));
      internal_tf_.setTransform(tf::StampedTransform(tf_l_hand_scaled_, calc_time,
  ...
  //  tf_broadcaster_.sendTransform(tf::StampedTransform(tf_r_shoulder_scaled_, ros::Time::now(),"/ref_frame", "/r_robot_shoulder"));
    internal_tf_.setTransform(tf::StampedTransform(tf_r_shoulder_scaled_, calc_time,"/ref_frame", "/r_robot_shoulder"));
  // tf_broadcaster_.sendTransform(tf::StampedTransform(tf_l_shoulder_scaled_, ros::Time::now(),"/ref_frame", "/l_robot_shoulder"));
    internal_tf_.setTransform(tf::StampedTransform(tf_l_shoulder_scaled_, calc_time,"/ref_frame", "/l_robot_shoulder"));
    /*
   ...
   // tf_broadcaster_.sendTransform(tf::StampedTransform(tf_r_shoulder_goal_, ros::Time::now(), "/r_robot_shoulder", "/r_shoulder_adapted"));
    internal_tf_.setTransform(tf::StampedTransform(tf_r_shoulder_goal_, calc_time, "/r_robot_shoulder", "/r_shoulder_adapted"));
  ...
  //  tf_broadcaster_.sendTransform(tf::StampedTransform(tf_l_shoulder_goal_, ros::Time::now(), "/l_robot_shoulder", "/l_shoulder_adapted"));
    internal_tf_.setTransform(tf::StampedTransform(tf_l_shoulder_goal_, calc_time, "/l_robot_shoulder", "/l_shoulder_adapted"));
  ...
  bool adaptElbows()
  {
    ...
    internal_tf_.setTransform(tf::StampedTransform(tf_r_elbow_pos_, calc_time, "/r_shoulder_adapted", "/r_elbow_pos"));
  ...
  //  tf_broadcaster_.sendTransform(tf::StampedTransform(tf_l_elbow_pos_, ros::Time::now(), "/l_shoulder_adapted", "/l_elbow_pos"));
    internal_tf_.setTransform(tf::StampedTransform(tf_l_elbow_pos_, calc_time, "/l_shoulder_adapted", "/l_elbow_pos"));
...
//    }
   ...
   // tf_broadcaster_.sendTransform(tf::StampedTransform(tf_r_elbow_goal_, ros::Time::now(), "/r_shoulder_adapted", "/r_elbow_adapted"));
    internal_tf_.setTransform(tf::StampedTransform(tf_r_elbow_goal_, calc_time, "/r_shoulder_adapted", "/r_elbow_adapted"));
   ...
   // tf_broadcaster_.sendTransform(tf::StampedTransform(tf_l_elbow_goal_, ros::Time::now(), "/l_shoulder_adapted", "/l_elbow_adapted"));
    internal_tf_.setTransform(tf::StampedTransform(tf_l_elbow_goal_, calc_time, "/l_shoulder_adapted", "/l_elbow_adapted"));
  ...
  bool adaptHands()
  {
   ...
   // tf_broadcaster_.sendTransform(tf::StampedTransform(tf_r_hand_adjusted_, ros::Time::now(), "/r_elbow_adapted", "/r_hand_adapted"));
    internal_tf_.setTransform(tf::StampedTransform(tf_r_hand_adjusted_, calc_time, "/r_elbow_adapted", "/r_hand_adapted"));
   ...
   // tf_broadcaster_.sendTransform(tf::StampedTransform(tf_l_hand_goal_, ros::Time::now(), "/l_elbow_adapted", "/l_hand_adapted"));
    internal_tf_.setTransform(tf::StampedTransform(tf_l_hand_goal_, calc_time, "/l_elbow_adapted", "/l_hand_adapted"));
  ...
  void convertTfToPoseMsg(std::vector<geometry_msgs::PoseStamped>& adapted_transforms)
  {
    ...
    pose_adapted_.header.frame_id = "/torso_adapted";
    ...
    // Head
    pose_adapted_.header.stamp = ros::Time::now();
    pose_adapted_.header.frame_id = "/head_adapted";
    pose_adapted_.pose.position.x = tf_head_goal_.getOrigin().x();
    pose_adapted_.pose.position.y = tf_head_goal_.getOrigin().y();
    pose_adapted_.pose.position.z = tf_head_goal_.getOrigin().z();
    pose_adapted_.pose.orientation.x = tf_head_goal_.getRotation().x();
    pose_adapted_.pose.orientation.y = tf_head_goal_.getRotation().y();
    pose_adapted_.pose.orientation.z = tf_head_goal_.getRotation().z();
    pose_adapted_.pose.orientation.w = tf_head_goal_.getRotation().w();
    adapted_transforms.push_back(pose_adapted_);

    // Right elbow
    pose_.header.stamp = ros::Time::now();
    pose_adapted_.header.frame_id = "/r_elbow_adapted";
    ...
    // Right hand
    pose_adapted_.header.stamp = ros::Time::now();
    pose_adapted_.header.frame_id = "/r_hand_adapted";
    ...
    // Left elbow
    pose_adapted_.header.stamp = ros::Time::now();
    pose_adapted_.header.frame_id = "/l_elbow_adapted";
    ...
    // Left hand
    pose_adapted_.header.stamp = ros::Time::now();
    pose_adapted_.header.frame_id = "/l_hand_adapted";
